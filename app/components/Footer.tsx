...
export const Footer = () => {
  return (
    <div className="flex flex-col w-full items-start">
      <div className="px-10 py-0 bg-[#4d555d] flex flex-col items-center w-full">
        <div className="flex max-w-[1400px] w-full h-[75px] items-center justify-between py-6">
          <Link
            href="/newcomers"
            className="font-medium text-white text-base whitespace-nowrap tracking-[-0.32px] leading-[25px]"
          >
            새신자
          </Link>

          <span className="font-normal text-[#ffffff4c] text-base whitespace-nowrap tracking-[-0.32px] leading-[25px]">
            /
          </span>
